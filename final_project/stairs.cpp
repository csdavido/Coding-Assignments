...
** about the room
******************************/
void Stairs::displayInfo() {
	cout << "These are the stairs. You can go past them to reach the kitchen." << endl;
	cout << "You can turn around and go to the living room." << endl;
	cout << "Going up leads to the upstairs hallway." << endl;
}